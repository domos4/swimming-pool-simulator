...
in all web browsers. Service worker registration [won't be attempted](src/serviceWorker.ts)
...
starting point, you can make use of the logic included in [`src/registerServiceWorker.js`](src/serviceWorker.ts), which
